    ...
    <div v-else class="grid quiz-item w-full border-4 place-self-center place-content-center text-center">
      ...
      <ul class="lg:w-2/3 place-self-center mb-8">
        <li :class="{ [`bg-stone-400 border-amber-500`]: highlighted[1], ['border-green-400']: greenOutline[0] }"
          ...
          <div v-if="greenOutline[0]"><lottie-player autoplay loop mode="normal"
        ...
        <li v-if="quizItem.option3"
          ...
          <div v-if="greenOutline[2]"><lottie-player autoplay loop mode="normal"
              src="https://lottie.host/04d9a56b-e383-4605-9749-915cae256759/SRskGhnVY5.json"
              style="width: 100px"></lottie-player></div>
        </li>
        <li v-if="quizItem.option4"
          ...
          <div v-if="greenOutline[3]"><lottie-player autoplay loop mode="normal"
              src="https://lottie.host/04d9a56b-e383-4605-9749-915cae256759/SRskGhnVY5.json"
              style="width: 100px"></lottie-player></div>
        </li>
